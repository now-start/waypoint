...
public record TagoCollectionProperties(
    ...
    private static final int DEFAULT_ARRIVAL_MAX_STOPS_PER_RUN = 30;
    private static final int MAX_ARRIVAL_MAX_STOPS_PER_RUN = 500;
    ...
    public TagoCollectionProperties {
        ...
        arrivalMaxStopsPerRun = boundedArrivalMaxStopsPerRun(arrivalMaxStopsPerRun);
    }
    ...
    private static int boundedArrivalMaxStopsPerRun(int value) {
        return value > 0
                ? Math.min(value, MAX_ARRIVAL_MAX_STOPS_PER_RUN)
                : DEFAULT_ARRIVAL_MAX_STOPS_PER_RUN;
    }
}
