...
class TagoCollectionPropertiesTest {
    ...
    void collectionConcurrencyDefaultsToFour() {
        ...
        TagoCollectionProperties properties = new TagoCollectionProperties(0, 0, 0, 0);
    ...
    @Test
    @DisplayName("수집 동시성과 TPS 제한은 TAGO 상한 아래로 제한한다")
    void collectionLimitsAreCapped() {
        // when: 과도한 동시성과 TPS를 지정한다
        TagoCollectionProperties properties = new TagoCollectionProperties(20, 20, 20, 100);
