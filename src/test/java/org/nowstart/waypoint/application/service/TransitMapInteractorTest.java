...
class TransitMapInteractorTest {
    ...
    void getMapReturnsRoutePathsAndLatestVehicles() {
        ...
        given(loadTransitDataPort.loadRoutePathStops("38010", 20_000)).willReturn(List.of(
        ...
        given(loadTransitDataPort.loadRecentLocationSnapshots(eq("38010"), argThat(since -> since.isBefore(old)), eq(2_000)))
                .willReturn(List.of(
